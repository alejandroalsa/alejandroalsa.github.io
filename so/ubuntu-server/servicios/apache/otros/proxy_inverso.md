...
![IMG](https://dc722jrlp2zu8.cloudfront.net/media/django-summernote/2018-03-28/f6daf1b0-372f-4a03-93ec-8e141d588a67.png)
...
Acabamos de configurar un proxy que examina y reescribe el HTML de nuestro sitio web, pero evidentemente existe más contenido en nuestro sitio que no es HTML y no debería ser procesado por `proxy_htm`l. Esto se soluciona verificando la cabecera del contenido y rechazando todos los contenidos que no tengan el tipo MIME adecuado.
...
[Siguiente Tema](/so/ubuntu-server/servicios/apache/otros/logs_awstats/)
