...
Vamos a instalar y configurar awstats para mostrar los datos estadísticos del virtual host`www.alejandroalsa.es`. Para cualquier otro virtual host los pasos de configuración serían similares.
...
[Fin del Curso](/so/ubuntu-server/servicios/apache/)
